...
from app.core.config import CONFIG, error_logger, logger as app_logger
...
async def audit_middleware(request: Request, call_next):
    from app.services.audit import should_audit, audit_from_request
        ...
        try:
            ...
            if request.method in ("POST", "PUT") and hasattr(request, "_body") and request._body:
                try:
                    ...
                    body = None
            from app.services.audit import write_audit_log, _parse_resource
...
async def startup():
    ...
    from app.services.scheduler import startup_scheduler
...
async def shutdown():
    ...
    from app.services.proxy_runtime.client import close_http_client
