...
from app.core.database import SchedulerTask, SchedulerTaskLog, async_session_maker
...
async def _restore_reenable_jobs_on_startup():
    ...
    try:
        from app.services.provider_limiter import restore_pending_reenable_jobs
